        ...
        while(true)
        {
            ...
            try
            {
                ...
                if(sender.equals(PHONE)) {
                    ...
                    {
                        if(fromDeviceCommandQueue.equals(PIC_OK)) {
                            Path filepath = new File("C:\\Users\\SELAB\\IdeaProjects\\Image\\temp.jpg").toPath();
                ...
                else if(sender.equals(DEVICE))
                {
                    ...
                    if(command.equals(CHECK))
                    {
                        ...
                        {
                            final var filepath = Paths.get("C:\\Users\\SELAB\\IdeaProjects\\Image\\temp.jpg");
                    ...
                    else if(command.equals(PIC_OK)){
                        client.close();
                        fromDeviceCommandQueue.add(PIC_OK);
                        log("pic_ok 커맨드 등록");
                        continue;
                    }
                }
